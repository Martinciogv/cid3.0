...
?>
    <!--
<?php foreach ($estadosIMP as $estado) : ?>
<?php echo $colores[$estado]; ?>
...
-->
    ...
    <?php
    // Define an array of statuses and their corresponding labels and CSS classes
    $statuses = [
    ...
    // Loop through the statuses to generate modals
    ...
    <?php
    // Definir un array con la información de los modales
    $modals = array(
