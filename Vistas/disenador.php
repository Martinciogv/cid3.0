                ...
                <div class="col-sm-12">
                    <form action="../procesos/diseno/regDisenador.php" method="POST" autocomplete="off">
                        <div class="container">
                                ...
                                <div class="col-sm-4 text">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <select class="form-control form-control-sm" id="cliente" name="cliente" required>
                                            <?php
                                            // Consulta para obtener el último id_cliente
                                ...
                                <div class="col-sm-4 text">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <select class="form-control input-sm form-control-sm" id="usuarioD" name="usuarioD" required>
                                            <option value="<?php echo $_SESSION['iduser'] ?>"><?php echo $_SESSION['usuario'] ?>
                                            </option>
                                            <?php
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <h2>Orden de impresión</h2>
                                </div>

                                <div class="col-sm-6">
                                    <label>Fecha de entrega impresión</label>
                                    <input type="date" name="fecha_entrega_imp" class="form-control form-control-sm" step="1" value="<?php echo date("Y-m-d"); ?>">
                                </div>
                            </div>
